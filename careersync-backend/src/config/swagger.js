...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: `
# CareerSync - Home Services Platform API

Welcome to the CareerSync API documentation. CareerSync is a comprehensive home services marketplace that connects customers with skilled service partners.
