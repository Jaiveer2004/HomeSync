        ...
        <div className="container mx-auto py-8 px-4 space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <Link href="/partner/services/create">
              <Button className="bg-[#1e40af] hover:bg-[#1e3a8a] text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <div className="relative">
                    <svg className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div key={service._id} className="bg-white rounded-2xl p-6 border border-slate-200 hover:border-slate-300 transition-all duration-200 shadow-lg hover:shadow-xl group">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <span className="text-sm text-[#1e40af] bg-blue-400/10 px-3 py-1 rounded-full inline-block">
                          {service.category}
                        </span>
                      </div>
